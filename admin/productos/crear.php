<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if(!$imagen || !$imagen['name']){ $errores[]='La imagen es obligatorio'; }
        ...
        if(empty($errores)){
            ...
            $sql = "INSERT INTO productos (titulo, precio, descripcion, cantidad, categoria, talla, genero, color, vendedor,imagen)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ? ,?)";
            $params = [$titulo,$precio,$descripcion,$cantidad,$categoria,$talla,$genero,$color,$vendedor,$nombreImg];
